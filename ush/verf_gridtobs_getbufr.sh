...
DATEM01=`/nwprod/util/exec/ndate +1 $DATE`
echo $DATEM01 > datem01
DATEM02=`/nwprod/util/exec/ndate +2 $DATE`
echo $DATEM02 > datem02
DATEM03=`/nwprod/util/exec/ndate +3 $DATE`
echo $DATEM03 > datem03
DATEM04=`/nwprod/util/exec/ndate +4 $DATE`
echo $DATEM04 > datem04
DATEM05=`/nwprod/util/exec/ndate +5 $DATE`
...
DATE3=`/nwprod/util/exec/ndate -3 $DATE`
echo $DATE3 > date3
