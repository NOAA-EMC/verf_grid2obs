...
C***TLO 11 Mar 04 ***start
     ...
     &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
      DATA  GRD139/ 0, 255, 3, 469,289,  20953,-123319,   8,   -97000,
     &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
C***TLO 11 Mar 04 ***end
C***TLO 08 Mar 04 ***start
      DATA  GRD140/ 0, 255, 3, 270,261,  24486,-101108,   8,   -97000,
     &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
      DATA  GRD141/ 0, 255, 3, 271,262,  24431,-101163,   8,   -97000,
     &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
      DATA  GRD142/ 0, 255, 3, 268,259,  24595,-100998,   8,   -97000,
     &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
      DATA  GRD144/ 0, 255, 3, 168,144,  32233, -90104,   8,   -79500,
...
C***TLO 08 Mar 04 ***start
     ...
     &  12000, 12000, 0, 64, 0, 36000, 46000, 0, 0/
      DATA  GRD148/ 0, 255, 3, 444,267,  21694,-120707,   8,   -97000,
     &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
      DATA  GRD149/ 0, 255, 3, 445,268,  21630,-120747,   8,   -97000,
     &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
      DATA  GRD150/ 0, 255, 3, 442,265,  21821,-120628,   8,   -97000,
     &  12000, 12000, 0, 64, 0, 33000, 45000, 0, 0/
C***TLO 08 Mar 04 ***end
...
C***TLO 08 Mar 04 ***start
      ELSE IF (IGRID.EQ.140) THEN
        DO 1108 I = 1,18
          IGDS(I) = GRD140(I)
1108    CONTINUE
      ELSE IF (IGRID.EQ.141) THEN
        DO 1109 I = 1,18
          IGDS(I) = GRD141(I)
1109    CONTINUE
      ELSE IF (IGRID.EQ.142) THEN
        DO 1110 I = 1,18
          IGDS(I) = GRD142(I)
1110    CONTINUE
      ELSE IF (IGRID.EQ.144) THEN
        DO 1208 I = 1,18
          IGDS(I) = GRD144(I)
1208    CONTINUE
C***TLO 08 Mar 04 ***end
