...
c     print*,'sid,subset=',sid,subset
c     if(hdr(6).eq.435.0.or.hdr(6).eq.535.0.or
c    *  .hdr(6).eq.431.0) subset='AIRCFT'
      if(hdr(6).ge.240.0.and.hdr(6).le.259.0) subset='SATWND'
c     if(hdr(6).eq.224.0) subset='VADWND'
c     if(hdr(6).eq.433.0.or.hdr(6).eq.533.0) subset='AIRCAR'
      if(hdr(6).gt.300.0) subset='AIRSND'
...
c     print*,'reading here!!!'
      call ufbint(lunit,obn8,3,5,nlen8,'VSSO CLAM HOCB')
c     print*,'nlev8=',nlev8
c     do i=1,nlev8
c      print*,'obs8(1,i)=',obs8(1,i)
c      print*,'obs8(2,i)=',obs8(2,i)
c      print*,'obs8(3,i)=',obs8(3,1)
c     enddo
      nlen8=nlev8
      if(nlev3.eq.0) then
          obs3=bmiss
...
C     ---------------------------------------
      ...
      call ufbint(lunit,obs8,3,5,nlev8,'VSSO CLAM HOCB')
c     print*,'nlev8=',nlev8
c     do i=1,nlev8
c      print*,'obs8(1,i)=',obs8(1,i)
c      print*,'obs8(2,i)=',obs8(2,i)
c      print*,'obs8(3,i)=',obs8(3,i)
c     enddo
...
c     print*,'nlen8,nlev8=',nlen8,nlev8
      DO 93 l2 = 1, nlen8
        DO l1 = 1, nlev8
