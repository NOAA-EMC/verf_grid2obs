...
c           CALL w3fb11(yob,xob,alat1,elon1,dxm,elonv,alatan,xi,yj)
            call w3fb13(yob,xob,alat1,elon1,dxm,elonv,alatan1,alatan2,
     *             xi,yj)
            print*,'yob,xob,xi,yj=',yob,xob,xi,yj
...
C         ----------------------------
          print*,'kxi(n),kyj(n),imax,jmax=',
     *     kxi(n),kyj(n),imax,jmax
...
c           print*,'cpi(n,ibak)=',cpi(n,ibak)
     ...
     +                pli(kxi(n)+1,kyj(n)+1)
	  IF ( chk ( mskoz1(i,j), mskoz1(i1,j), mskoz1(i,j1),
     +		   mskoz1(i1,j1) ) ) oz1i(n,ibak) = wtsw(n) * 
     +             oz1s(kxi(n),kyj(n)) + wtse(n) * oz1s(kxi(n)+1,kyj(n))
     +             + wtnw(n) * oz1s(kxi(n),kyj(n)+1) + wtne(n) * 
     +             oz1s(kxi(n)+1,kyj(n)+1)
	  IF ( chk ( mskoz8(i,j), mskoz8(i1,j), mskoz8(i,j1),
     +		   mskoz8(i1,j1) ) ) oz8i(n,ibak) = wtsw(n) * 
     +             oz8s(kxi(n),kyj(n)) + wtse(n) * oz8s(kxi(n)+1,kyj(n))
     +             + wtnw(n) * oz8s(kxi(n),kyj(n)+1) + wtne(n) * 
     +             oz8s(kxi(n)+1,kyj(n)+1)
